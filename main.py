...
@bot.command(name=BOT_CMD, help="Talk to the bot")
...
async def interact(context, action_text):
    ...
    print(context.message.author.display_name)
    action_text = " " + action_text
    action_text = action_text.replace(" I ", "")
